...
| --- | --- | --- |
| Crafter | Canonical `CrafterReward-v1` RGB task with all 17 actions and all 22 achievements; official shifted-geometric achievement scoring plus a survival-gated long-horizon development profile | [`crafter/crafter/`](crafter/crafter/) |
