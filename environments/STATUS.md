...
| --- | --- | --- |
| Crafter | Canonical `CrafterReward-v1` RGB task with all 17 actions, all 22 achievements, and the official shifted-geometric achievement score | [`crafter/crafter/`](crafter/crafter/) |
