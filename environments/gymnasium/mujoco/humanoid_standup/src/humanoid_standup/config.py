"""Typed, public HumanoidStandup-v5 environment configuration."""
...
class HumanoidStandupConfig:
    """Parameters that define one HumanoidStandup Benchmark identity."""

    frame_skip: int = 5
    ctrl_cost_weight: float = 0.1
    impact_cost_weight: float = 0.0000005
    impact_cost_range: tuple[float | None, float] = (None, 10.0)
    ...
    def __post_init__(self) -> None:
        ...
        _weight(self.impact_cost_weight, name="impact_cost_weight")
        _clamp_range(self.impact_cost_range, name="impact_cost_range")
