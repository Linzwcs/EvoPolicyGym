"""Run one explicitly unsafe local Codex development loop on Robotics."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run a real Codex Agent against a Gymnasium-Robotics Benchmark.",
    )
    parser.add_argument("--record-to", type=Path, required=True)
    parser.add_argument("--profile", choices=ROBOTICS_PROFILES, default="fetch-reach")
