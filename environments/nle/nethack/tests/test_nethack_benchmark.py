...
class NetHackBenchmarkTests(unittest.TestCase):
    ...
    def test_spec_baseline_agent_skill_and_tool_dependencies_are_packaged(self) -> None:
        ...
        self.assertIn("optimize-nethack-policy", benchmark.spec.agent_skill)
        self.assertIn("analysis/", benchmark.spec.agent_skill)
        self.assertIn("frozen_step_fraction", benchmark.spec.agent_skill)
        self.assertIn("behaviorally distinct", benchmark.spec.agent_skill)
