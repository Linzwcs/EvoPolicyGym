"""Run one explicitly unsafe local Codex development loop on robosuite."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run a real Codex Agent against a robosuite Benchmark.",
    )
    parser.add_argument("--record-to", type=Path, required=True)
    parser.add_argument("--profile", choices=ROBOSUITE_PROFILES, default="lift")
