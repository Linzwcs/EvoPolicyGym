...
class AirstrikerBenchmarkTests(unittest.TestCase):
    ...
    def test_feedback_publishes_bounded_lossless_visual_trace(self) -> None:
        ...
        feedback = AirstrikerBenchmark().feedback((record,))
        ...
        self.assertEqual(transition_trace[1]["action_buttons"], ["UP"])
        self.assertEqual(
        ...
        with numpy.load(
            ...
            self.assertEqual(frames["initial_frame"].shape, (224, 320, 3))
            self.assertEqual(
        ...
        with Image.open(io.BytesIO(replay_content)) as replay:
            ...
            self.assertEqual(replay.size, (640, 476))
        ...
        self.assertEqual(frame_manifest["replay_frames_omitted"], 9)
