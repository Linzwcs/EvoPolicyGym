...
export const environmentCollections: EnvironmentCollection[] = [
  ...
  },
  {
    id: "dm-control",
    domain: "control",
    ecosystem: "DeepMind Control Suite",
    suite: "BENCHMARKING",
    distributions: 1,
    taskProfiles: 28,
    coverage: { en: "28 tasks · 14 domains", zh: "28 个任务 · 14 个领域" },
    summary: {
      en: "Canonical state-based continuous-control tasks from balancing and locomotion to manipulation.",
      zh: "从平衡、运动控制到操作任务的标准状态型连续控制环境。",
    },
    policyInterface: {
      en: "Named state tensors and bounded continuous Actions",
      zh: "具名状态 Tensor 与有界连续 Action",
    },
    score: { en: "Mean continuous return", zh: "平均连续回报" },
    sourcePath: "environments/dm_control/control_suite",
    items: [
      { name: "Acrobot / Cartpole / Pendulum" },
      { name: "Ball in Cup / Finger" },
      { name: "Cheetah / Hopper / Walker" },
      { name: "Fish / Swimmer" },
      { name: "Humanoid" },
      { name: "Manipulator / Point Mass / Reacher" },
    ],
  },
  {
  ...
  },
  {
    ...
    domain: "planning",
    ecosystem: "Jumanji",
    suite: "Single-Policy tasks",
    distributions: 1,
    taskProfiles: 18,
    coverage: {
      en: "18 logic, packing, and routing tasks",
      zh: "18 个逻辑、装箱与路径规划任务",
    },
    summary: {
      en: "Structured combinatorial environments with exact action masks and task-specific progress diagnostics.",
      zh: "具有精确 Action mask 与任务专属进度诊断的结构化组合环境。",
    },
    policyInterface: {
      en: "Named structured state and masked discrete Actions",
      zh: "具名结构化状态与带 mask 的离散 Action",
    },
    score: { en: "Mean Episode return", zh: "Episode 平均回报" },
    sourcePath: "environments/jumanji/jumanji",
    items: [
      { name: "2048 / Graph Coloring / Minesweeper" },
      { name: "Rubik's Cube / Sudoku / Sliding Tile" },
      { name: "BinPack / FlatPack / Knapsack" },
      { name: "JobShop / Tetris" },
      { name: "CVRP / TSP / Maze" },
      { name: "Snake / PacMan" },
    ],
  ...
  },
  {
    ...
    distributions: 1,
    taskProfiles: 19,
    coverage: { en: "19 manipulation tasks", zh: "19 个机器人操作任务" },
    summary: {
      en: "Single- and dual-arm Panda manipulation with dense task state and per-Episode visual evidence.",
      zh: "使用单臂或双臂 Panda、稠密任务状态与逐 Episode 视觉证据的机器人操作环境。",
    },
    policyInterface: {
      en: "Proprioception, object state, and OSC pose control",
      zh: "本体感知、物体状态与 OSC 位姿控制",
    },
    score: { en: "Episode success rate", zh: "Episode 成功率" },
    sourcePath: "environments/robosuite/robosuite",
    items: [
      { name: "Lift / Stack" },
      { name: "NutAssembly" },
      { name: "PickPlace" },
      { name: "Door / Wipe / ToolHang" },
      { name: "TwoArmLift / TwoArmPegInHole" },
      { name: "TwoArmHandover / TwoArmTransport" },
    ],
  },
  {
    id: "highway-env",
  ...
  },
  {
    ...
    taskProfiles: 25,
    coverage: {
      en: "25 pinned public games · custom collections",
      zh: "25 个固定版本公开游戏 · 自定义集合",
    },
    summary: {
      en: "Interactive visual reasoning across complete games, in-Episode level resets, and official scorecard aggregation.",
      zh: "覆盖完整游戏、Episode 内关卡重置与官方计分卡聚合的交互式视觉推理。",
    },
    policyInterface: {
      en: "64 × 64 indexed frames and available discrete Actions",
      zh: "64 × 64 索引色画面与当前可用的离散 Action",
    },
    score: { en: "Official ARC-AGI-3 score", zh: "ARC-AGI-3 官方得分" },
    sourcePath: "environments/arcprize/arc_agi_3",
    items: [
      { name: "25 version-pinned public games" },
      { name: "Custom fixed collections" },
    ],
  },
  {
    id: "nle-nethack",
