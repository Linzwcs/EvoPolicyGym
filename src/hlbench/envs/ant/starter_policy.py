...
class Policy:
    """Ant-v5 ``Policy`` implementing the SPEC §2 contract."""
    ...
    def act(self, obs: np.ndarray) -> np.ndarray:
        ...
        Args:
            obs: np.ndarray shape (105,) dtype float64. See TASK.md.

        Returns:
            np.ndarray shape (8,) dtype float32, joint torques in [-1.0, 1.0].
        """
