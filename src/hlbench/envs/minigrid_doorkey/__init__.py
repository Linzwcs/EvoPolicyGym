"""MiniGrid-DoorKey-16x16-v0 env registration (MiniGrid-DoorKey-16x16-v0).

MiniGrid task: Navigate a 16x16 grid, pick up the key, unlock the door, reach the goal.
...
Side effect: importing this module registers ``minigrid_doorkey``.
"""
...
def _factory() -> object:
    ...
    base = gymnasium.make("MiniGrid-DoorKey-16x16-v0", render_mode=None)
