# MiniGrid-ObstructedMaze-2Dlhb-v0 — MiniGrid Partially-Observable Navigation

## Goal

Navigate a maze with locked doors hidden behind boxes; find the blue ball.

**Mission text (constant for this env):** *"pick up the blue ball"*
...
Hardest MiniGrid variant: doors blocked by boxes (must drop key, push box, pick up key, then unlock). Requires multi-step object manipulation, not just navigation.
